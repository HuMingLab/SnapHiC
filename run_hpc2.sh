...
mpirun -np 10 python ./snap.py -i $indir -s $suffix -o $outdir -c $chrs -p $pos -l $chrlen -g $genome --fdr-threshold $fdr_thresh --filter-file $filter_file --steps $steps --parallel
