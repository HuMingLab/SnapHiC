...
### 1. Installation
Singularity images of the pipeline will be provided [here](http://renlab.sdsc.edu/abnousa/public_html/snapHiC/singularity_releases) eliminating the need for installation. If you don't have access to singularity or would prefer your own installation please follow the steps below:    
