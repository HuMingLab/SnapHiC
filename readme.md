...
- outlier_count: number of cells with >1.96 normalized contact probability (with respect to global background).  
...
- circle, donut, horizontal, vertical, lower_left: extra filters for fold change computed for each chromatin loop. See details in the manuscript. 
